                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ old('email', $getRecord->email) }}" placeholder="example@gmail.com"
                                            name="email">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ old('bank_name', $getRecord->bank_name) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-university"></span></span>
                                        <input type="text" class="form-control"
                                            value="{{ old('bank_account_no', $getRecord->bank_account_no) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control"
                                            value="{{ old('due', $getRecord->due) }}" placeholder="0.0 ৳"
                                            name="due">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-money"></span></span>
                                        <input type="number" class="form-control"
                                            value="{{ old('paid', $getRecord->paid) }}" placeholder="0.0 ৳"
                                            name="paid">
                                    </div>
