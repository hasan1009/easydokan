                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>এড</strong> খরচ</h3>
                        ...
                        <div class="panel-body">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('name') }}" required
                                            placeholder="খরচের টাইটেল" name="name">
                                    </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" value="{{ old('amount') }}" required
                                            placeholder="0.0 টাকা" name="amount">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                        <input type="date" class="form-control" value="{{ old('expense_date') }}"
                                            required placeholder="খরচের তারিখ" name="expense_date">
                                    </div>
