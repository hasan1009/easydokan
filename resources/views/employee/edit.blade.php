                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>এডিট</strong> কর্মকর্তা/কর্মচারী</h3>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control"
                                            value="{{ old('salary', $getRecord->salary) }}" placeholder="0.0 ৳"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                        <input type="text" class="form-control"
                                            value="{{ old('designation', $getRecord->designation) }}" required
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-money"></span></span>
                                        <input type="number" class="form-control"
                                            value="{{ old('holyday', $getRecord->holyday) }}" placeholder="0 দিন"
                                            name="holyday" required>
                                    </div>
